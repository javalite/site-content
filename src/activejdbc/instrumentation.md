...
<project default="instrument" basedir=".">
    ...
    <path id="instrument_classpath">
        ...
        <path location="${user.home}/.m2/repository/org/javalite/activejdbc-instrumentation/1.4.10/activejdbc-instrumentation-1.4.10.jar"/>
        <path location="${user.home}/.m2/repository/javassist/javassist/3.8.0.GA/javassist-3.18.2-GA.jar"/>
        <path location="${user.home}/.m2/repository/org/javalite/activejdbc/1.4.10/activejdbc-1.4.10.jar"/>
    </path>
